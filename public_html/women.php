...
<html>
    ...
    <title>Women - The Fashion Shop</title>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-heading text-uppercase" style="font-family:'Lithos Pro Regular';">Women</div>
		   <div class="intro-lead-in">Fashion of the Times</div>
