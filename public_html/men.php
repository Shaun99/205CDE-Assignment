...
<html>
   <head>
    ...
    <title>Men - The Fashion Shop</title>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-heading text-uppercase" style="font-family:'Lithos Pro Regular';">Men</div>
		   <div class="intro-lead-in">Bringing You the Elements of Style</div>
       ...
       <div class ="title">
        ...
        <br><br><br><br>
         ...
         <?php
            ...
            $sql = "SELECT * FROM item WHERE category = 0;";
