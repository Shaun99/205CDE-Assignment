...
<head>
    ...
    <title>View Customer Transaction History - The Fashion Shop</title>
    ...
    <header class="masthead">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in"> Database - View Customer Transaction History </div>
                        ...
                        if(mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>';
                                    ...
                                    echo '<td width="10%"><img src="img/'.$row2['image'].'" style="width:115px" height="130px"></td>';
                                ...
                                echo '<tr>
                                <td colspan="4" align="right"><b>Total Order: </b></td>';   
